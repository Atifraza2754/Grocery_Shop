            ...
            <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div class="flex flex-col gap-1">
                    <div class="flex gap-2">
                        <x-filament::button
                            wire:click="setType('repeated')"
                            size="sm"
                            :color="$this->type === 'repeated' ? 'primary' : 'gray'"
                        ...
                        <x-filament::button
                            wire:click="setType('new')"
                            size="sm"
                            :color="$this->type === 'new' ? 'primary' : 'gray'"
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400">
                        Showing <span class="font-medium">{{ $this->getWindowLabel() }}</span>
                    </p>
                </div>
